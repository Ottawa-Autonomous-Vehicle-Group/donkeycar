...
'''
data packet
[{'measurement': 'DonkeySimulator', 'tags': {'car': 'PLN_8', 'race': 'training'}, 
'time': 1589308655276593078, 
'fields': {
    'user/angle': 0.032319101535081024, 
    'user/throttle': 0.0019226660969878231, 
    'pos/pos_x': 64.08337, 
    'pos/pos_y': 5.169793, 
    'pos/pos_z': 45.43799, 
    'pos/speed': 0.001484435, 
    'pos/cte': -10.2906, 
    'istep': 8337}}]
...
641ff after tub handler

    # RBX: create influxdb client
    myinflux = InfluxController(path=cfg.DATA_PATH, inputs=inputs, types=types, user_meta=meta)
    V.add(myinflux, inputs=inputs, outputs=[""], threaded=True)
    # RBX
